...
from methods.backbone12 import model_dict
from data.datamgr import SimpleDataManager, SetDataManager
from methods.baselinetrain_regu_adlr2 import BaselineTrain
from methods.protonet import ProtoNet
from methods.matchingnet import MatchingNet
from methods.relationnet import RelationNet
from methods.gnnnet_q8_elu_mutual_5shot1 import GnnNet_m
from options_5shot import parse_args, get_resume_file, load_warmup_state
...
if __name__=='__main__':
  ...
  if params.method in ['baseline', 'baseline++'] :
    ...
    base_datamgr    = SimpleDataManager(image_size, batch_size=16)   #batchsize=16
    base_loader     = base_datamgr.get_data_loader( base_file , aug=params.train_aug )
    val_datamgr     = SimpleDataManager(image_size, batch_size=64)   #batchsize=64
    ...
    if params.method == 'protonet':
      ...
      model           = GnnNet_m( model_dict[params.model], tf_path=params.tf_dir, **train_few_shot_params)
