...
def parse_args(script):
  ...
  parser.add_argument('--save_dir'    , default='/public/qifan_Data/few-shot/CrossDomainFewShot-master/output/', type=str, help='')
  #parser.add_argument('--save_dir_qs'    , default='/public/qifan_Data/few-shot/CrossDomainFewShot-master/output/qs/', type=str, help='')

  parser.add_argument('--data_dir'    , default='/public/qifan_Data/few-shot/CrossDomainFewShot-master/filelists/', type=str, help='')
